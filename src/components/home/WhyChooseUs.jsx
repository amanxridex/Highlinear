      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="grid grid-cols-2 gap-4 relative">
          <div className="space-y-4 pt-12">
            ...
            <img src="https://images.unsplash.com/photo-1541888086425-d81bb19240f5?q=80&w=600&auto=format&fit=crop" className="rounded-[2rem] w-full h-48 object-cover" alt="Workers" />
          </div>
